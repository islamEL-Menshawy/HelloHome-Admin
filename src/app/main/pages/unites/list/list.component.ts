...
export class ListComponent implements OnInit {
  ...
  public searchValue = '';
  public typesToUpdate: UnitsResponse = null;
  public breadcrumbDefault: Breadcrumb;

  // Private
  private tempData: UnitsResponse = null;
  private _unsubscribeAll: Subject<void>;
  private readonly MODEL_NAME = "Unit";

  constructor(
      private _modalService: UnitesService,
  ...
  fireDeleteModel(id) {
    ...
    Swal.fire({
      title: 'Are you sure?',
      text: `Are you sure delete this ${this.MODEL_NAME}`,
      icon: 'warning',
